...
async def run_test():
    ...
    try:
        ...
        # -> Fill the E-mail field, fill the Senha field, then submit the form (send Enter).
        ...
        assert '/dashboard' in current_url, "The page should have navigated to the dashboard area after signing in."
